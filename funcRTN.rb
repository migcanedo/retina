...
$matrix = Array.new(1001) {Array.new(1001, 0)} #Representacion del BitMap.
...
class FuncionSetPosition
	...
	# Metodo que simula la ejecucion de la funcion.
	def run tabla, param
		$eye = [param[0].round + 500, param[1].round + 500]
